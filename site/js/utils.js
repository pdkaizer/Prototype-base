...
$(document).ready(function(){
		...
		var w = $('.contentImg img').innerWidth();
		$('.contentImg').css('width',w);

		
		//make columns equal height 
		var highestCol = Math.max($('.main-column').height(),$('.sub-column').height());
		$('.main-column').height(highestCol);
		
		$('.title-inner span a, .title-inner a span').css('marginLeft','0');
